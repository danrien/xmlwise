...
public class XmlElementAttributesTest extends TestCase
{
	...
	{
		m_attributes = new XmlElementAttributes(Xmlwise.createDocument("<x ab='cd' ef='12' y='12.5'/>").getRootElement());
	}
	...
	{
		XmlElementAttributes attributes = new XmlElementAttributes(Xmlwise.createDocument("<x ab='yes' ef='12' gh='true' ij='y' kl='no' m='n' o='false'/>").getRootElement());
